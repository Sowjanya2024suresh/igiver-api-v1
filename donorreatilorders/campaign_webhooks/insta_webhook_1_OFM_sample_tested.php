<?php
    ...
    function send_email($orderdetailarray,$campid,$retail_code)
    {
		...
		$mail->Subject ='Webhook From Campaign ID '.$campid.' And Retail Code '.$retail_code; 
     ...
     // print_r(explode('_',$filename));
      //  exit;
        ...
        //Record creating in payment_record table
         ...
         //$paymentid='MOJO1715E05Q18874822';
	     $retail_code="OFM";
	     $campid="1";
         ...
         send_email(json_encode($_POST),$campid,$retail_code);
          ...
          //CURLOPT_URL => 'http://cp.igiver.org/ngoapp/donorreatilorders/get_insta_webwookfile_common.php?paymentid='.$paymentid.'&campid='.$campid.'&retail_code='.$retail_code,
