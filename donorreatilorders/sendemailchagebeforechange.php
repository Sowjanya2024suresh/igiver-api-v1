...
<tr><td>
       ...
       if($towhom=="DONOR")
       {
           ...
           $successmessage=' <div class="h3-white-center" style="color: #008000;
       ...
       else if($towhom=="RETAILER")
       {
           ...
           $headmsg='Order Paid from iGiver.Org ';
       }else if($towhom=="NGO")
       {
           $tablecontent='';
            $successmessage='<div class="text-white-center" style="color:#000; font-family:Arial,sans-serif; font-size:12px; line-height:20px; text-align:center;padding: 0 8%;">
            ...
            $headmsg='You got Donation from iGiver.Org ';
       }
...
$mail->Body=$body;
//$mail->AddAttachment('igiverhtml.html', 'igiverhtml.html');
...
//$myFile = "igiverhtml.html"; // or .php   
//$fh = fopen($myFile, 'w'); // or die("error");  
//$stringData = htmlspecialchars($body);   
//fwrite($fh, $body);
//fclose($fh);

//echo 'http://65.0.244.240:3001/generatepdfigiver?htmlval='.$orderid.'&&ngoid='.$NGOid.'&&donorid='.$donorid;
 $curl = curl_init();
...
CURLOPT_URL => 'http://65.0.244.240:3001/generatepdfigiver?htmlval='.$orderid,
