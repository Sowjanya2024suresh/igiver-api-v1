...
if(isset($_GET['campid']) && !empty($_GET['campid']) && isset($_GET['retailcode']) && !empty($_GET['retailcode'])){
    
 $myfile = fopen("./campaign_webhooks/insta_webhook_".$campid."_".$retail_code.".php", "w") or die("Unable to open file!");

fwrite($myfile, $txt);
// $txt = "testing\n";
// fwrite($myfile, $txt);
fclose($myfile);
echo "insta_webhook_".$campid."_".$retail_code.".php file created";
}
else
{
    echo "Webhook file not created. Incorrect Parameters..";
}
